...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition checks who's rutn it is.
        if (activePlayer === 'X') {
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //If the 3 variables we pass are all included in our array tru is
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    let x1 = coordX1,
        ...
        function animateLineDrawing() {
            ...
            c.moveTo(x1, y1)
            //This method indications the end point in our line.
            c.lineTo(x, y)
            //lineWidth = 10;
        ...
        animateLineDrawing();
        //This line waits 1 second. then clears canvas, rests game, allows clicking again.
